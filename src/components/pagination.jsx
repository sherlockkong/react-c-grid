...
export default class Pagination extends React.Component {
    ...
    renderCountMsg = () => {
        ...
        if (typeof onFormatCountMsg === 'function')
            return onFormatCountMsg(selected, pageSize, itemsCount)
    ...
    render() {
        const { pageSize, itemsCount, selected, showCountMsg, visiblePageCount } = this.props
