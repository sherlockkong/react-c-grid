...
var Scrollbar = function (_React$Component) {
    ...
    function Scrollbar(props, context) {
        ...
        _this.onWindowResize = function () {
            setTimeout(_this.updateScrollBarSize, 1);
        };
        ...
        _this.onVBarMouseDown = function (e) {
            ...
            _this._mouseDownOffsetY = e.clientY - rect.y;
            e.preventDefault();
            e.stopPropagation();
        };
        ...
        _this.updateVBarPosition = function (clientY) {
            ...
            var offset = Math.ceil(_this._container.scrollHeight / rect.height * (clientY - rect.y));
        ...
        _this.onHBarMouseDown = function (e) {
            ...
            _this._mouseDownOffsetX = e.clientX - rect.x;
            e.preventDefault();
            e.stopPropagation();
        };
        ...
        _this.updateHBarPosition = function (clientX) {
            ...
            var offset = Math.ceil(_this._container.scrollWidth / rect.width * (clientX - rect.x));
