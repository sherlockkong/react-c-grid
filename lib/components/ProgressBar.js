...
var ProgressBar = function (_React$Component) {
	...
	function ProgressBar() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ProgressBar.__proto__ || Object.getPrototypeOf(ProgressBar)).call.apply(_ref, [this].concat(args))), _this), _this.componentDidMount = function () {
			...
			return React.createElement(
				'div',
				{
					...
					ref: function ref(_ref4) {
						return _this2._wrapper = _ref4;
					}
				},
				React.createElement(
					'div',
					{ ref: function ref(_ref3) {
							return _this2._barBg = _ref3;
						}, className: 'cg-progress-bar-bg' },
					React.createElement('div', { ref: function ref(_ref2) {
							return _this2._bar = _ref2;
