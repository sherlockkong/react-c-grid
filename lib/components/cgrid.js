...
var CGrid = function (_React$Component) {
    ...
    function CGrid(props, context) {
        ...
        _this.componentDidUpdate = function (nextProps) {
            if (nextProps.columns && _this.props.columns && nextProps.columns.length != _this.props.columns.length) {
                _this.initGridSize();
            }
        ...
        _this.getColWidths = function () {
            ...
            columns.forEach(function (col, index) {
                ...
                if (_this.props.autoFitWithColumnLabel) {
                    var _w = _this.measureColumnLabel(col.label);
        ...
        _this.measureColumnLabel = function (label) {
